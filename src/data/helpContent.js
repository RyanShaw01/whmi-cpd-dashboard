...
export const HELP_ARTICLES = [
  ...
  },
  {
    ...
    steps: [
      ...
      "**Informational**: visible to everyone the same as Registration Open, but there's no Register button and no attendance is collected - for anything you just want to list (an external conference, a drop-in session).",
    ...
    note: "Only \"Registration Open\" and \"Informational\" events appear to staff browsing Upcoming Events. You can change the status any time from the event's detail view.",
  },
  {
    id: "event-files",
    category: "events",
