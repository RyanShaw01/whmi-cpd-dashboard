...
export default function UpcomingEvents({
  ...
  const statuses = ["All", "Registration Open", "Open (No Registration Needed)", "Draft", "Awaiting Approval"];
    ...
    <div className="whmi-fade-in p-6 max-w-[1400px] mx-auto space-y-5">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-[13px]" style={{ color: "var(--text-dim)" }}>Only "Registration Open" and "Open (No Registration Needed)" events are visible to staff.</p>
        </div>
