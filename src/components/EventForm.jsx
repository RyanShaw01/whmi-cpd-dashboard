...
const STATUS_OPTIONS = ["Draft", "Awaiting Approval", "Registration Open", "Open (No Registration Needed)", "Registration Closed", "Completed", "Archived"];
    ...
    <form onSubmit={submit} className="space-y-4">
      ...
      <div>
        <div className="flex items-center gap-1.5">
          ...
          <InfoTooltip text={'"Open (No Registration Needed)" is visible to everyone the same as "Registration Open" - but there\'s no Register button, and no registrations/attendance are collected. Use it for anything you just want to list (e.g. an external conference, a drop-in session).'} />
        </div>
