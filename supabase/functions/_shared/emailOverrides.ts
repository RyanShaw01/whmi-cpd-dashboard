...
export async function getEmailOverride(
  ...
  supabaseAdmin: any,
  key: "registration_confirmation" | "post_event_thank_you" | "presenter_thank_you" | "event_reminder" | "reflection_reminder" | "certificate" | "reflection_copy" | "reflections_report",
  title: string,
